...
<body>
    ...
    <h4 class="text-success">หน้าร้านของ <?php echo $row['pub_name']?></h4>
    <h3>โปรโมชั่น</h3>
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 ">
            ...
            where pub_id = '$pubid' and book_status = '2' and pro_edate >= CURDATE()+ INTERVAL 1 DAY
        ...
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 ">
            ...
            $where = "pub_id = '$pubid' and book_status = '2' ORDER BY book_app DESC LIMIT 10";
            $sqlbook = select_where($col, $table, $where);
            if ($sqlbook->num_rows > 0) {
                while ($row = $sqlbook->fetch_assoc()) {
                    $bookdate = $row['book_app'];
