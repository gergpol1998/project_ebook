...
<body>
    ...
    <div class="container px-4 px-lg-5 mt-3">
        ...
        $where = "book_pubid = '$pubid' and book_status = '0' ORDER BY book_dateup DESC";
        ...
        <div class="col sm-3">
            <div class="text-center mb-3">
                ...
                <a onclick="canclebook(this.href); return false;" href="delete_book.php?bookid=<?php echo $row['book_id'] ?>"><button type="button" class="btn btn-danger">ลบ</button></a>
                <!-- Modal -->
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        ...
                        <?php
                            ...
                            echo "<h5>ผู้เผยแพร่</h5>";
                            echo "<h4>".$row['pub_penname']."</h4>";
                            echo "<a href='#'><button class='btn btn-primary'>ทดลองอ่าน</button></a>";
                        ?>
                    </div>
