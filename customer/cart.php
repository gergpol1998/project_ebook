                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="remove_cart.php?bookid=<?php echo $row['book_id']?>&act=remove"><button type='button'class='btn btn-danger'>ลบ</button></a>
                        ...
                        <tr>
                            <td class="text-end" colspan="4"><a href='index.php'><button type='button'
                                        class="btn btn-outline-secondary">เลือกสินค้า</button></a></td>
                            <td class="text-center"><a href='confirm_cart.php'><button type='button'
                                        class="btn btn-primary">ชำระเงิน</button></a></td>
                            <td><a href='cancle_cart.php?act=cancle'><button type='button'
                                        class='btn btn-danger'>ยกเลิกสินค้า</button></a></td>
                        </tr>
                    </table>
                </div>
            </div>
